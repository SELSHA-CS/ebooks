import 'package:ebooks/statemanagement/using%20multi%20provider/controller/counter_provider.dart';
...
class IncreCount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var counterProvider = Provider.of<CounterProvider1>(context); //specify which provider is working on this screen
    return Scaffold(
      appBar: AppBar(
